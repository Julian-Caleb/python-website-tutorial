...
from flask import Blueprint, render_template, request, flash, redirect, url_for # Import
from .models import User
from werkzeug.security import generate_password_hash, check_password_hash # Import werkzeug for password
from . import db
